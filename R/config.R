...
KNOWN_CONFIG_KEYS <- c(
  ...
  "MIN_QC_SAMPLE_DETECTION", "QC_OUTLIER_MAD_K", "QC_OUTLIER_MIN_N",
  "MIN_BATCH_DETECTION", "MIN_BATCH_DETECTION_FRAC", "QC_RSD_FILTER",
  "RSD_THRESHOLD", "RUV_K", "SERRF_NUM", "LOESS_QC_SPAN", "LOESS_SAMPLE_SPAN",
  "DRIFT_SAMPLE_MIN_OBS", "DRIFT_MIN_QC_PER_BATCH", "DRIFT_MIN_LTQC_VALIDATE",
  "DRIFT_HYBRID_VALIDATE",
  "AUTO_LOESS_SPANS", "AUTO_HUBER_KS", "AUTO_SAMPLE_LOESS_SPANS", "AUTO_SAMPLE_HUBER_KS",
  ...
  "CORDBAT_REF_BATCH", "WAVEICA_ALPHA", "WAVEICA_CUTOFF", "WAVEICA_K", "WAVEICA_WF",
  "WAVEICA_EVAL_GROUP",
  "WAVEICA_V1_WF", "WAVEICA_V1_K", "WAVEICA_V1_T", "WAVEICA_V1_T2", "WAVEICA_V1_ALPHA",
